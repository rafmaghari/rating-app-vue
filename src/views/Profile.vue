            ...
            <ul
              ...
              <li class="flex items-center py-3">
                ...
                <span class="ml-auto"><span
                    class="bg-green-500 py-1 px-2 rounded text-white text-sm">{{user.is_active == 1 ? 'Active' : 'Inactive'}}</span></span>
              </li>
              <li class="flex items-center py-3">
                <span>Member since</span>
                <span class="ml-auto"><span
                    class="bg-green-500 py-1 px-2 rounded text-white text-xs">{{user.created_at}}</span></span>
              </li>
            </ul>
          </div>
          <!-- End of profile card -->
            ...
            <div class="text-gray-700">
              <div class="grid md:grid-cols-2 text-sm">
                ...
                <div class="grid grid-cols-2">
                  ...
                  <div class="px-4 py-2">{{user.gender == 1 ? 'Male' : 'Female'}}</div>
                </div>
                <div class="grid grid-cols-2">
